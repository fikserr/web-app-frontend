...
const Report = () => {
	...
	const { balance, loading, error } = useBalance(1284897972)
				...
				<div className='mt-6 space-y-6'>
					...
					<div className='bg-white shadow rounded-lg p-4 border'>
						...
						<p>
							Menga qarzdor:{' '}
							<b>
								{akt.data.initial.ktSum} uzs / {akt.data.initial.ktVal} $
							</b>
						</p>
						<p>
							Men qarzdor:{' '}
							<b>
								{akt.data.initial.dtSum} uzs / {akt.data.initial.dtVal} $
							</b>
						</p>
					</div>
						...
						{akt.data.list.map((item, idx) => (
							<div key={idx} className='bg-slate-50 rounded p-3 shadow-sm'>
								...
								<div className='flex justify-between text-sm mt-2'>
									<span>
										Menga qarzdor: <b>{item.ktSum} uzs</b>
									</span>
									<span>
										Men qarzdor: <b>{item.dtSum} uzs</b>
									</span>
								</div>
							</div>
						))}
					...
					<div className='bg-white shadow rounded-lg p-4 border'>
						...
						<p>
							Menga qarzdor:{' '}
							<b>
								{akt.data.last.ktSum} uzs / {akt.data.last.ktVal} $
							</b>
						</p>
						<p>
							Men qarzdor:{' '}
							<b>
								{akt.data.last.dtSum} uzs / {akt.data.last.dtVal} $
							</b>
						</p>
					</div>
				</div>
